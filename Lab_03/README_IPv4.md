...
1. Создание сети и настройка основных параметров устройств;
	а. Настройка маршрутизации между VLAN на маршрутизаторе R1;
	б. Настройка активных интерфейсов и статической маршрутизации для обоих маршрутизаторов;
	в. Настройка VLAN и интерфейсов на SW1 и SW2;
