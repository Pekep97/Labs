...
Создаlbv пул DHCPv6 на маршрутизаторе R1 для сети 2001:db8:acad:3:aaaa::/80. Это предоставит адреса локальной сети, подключенной к интерфейсу e0/1 на маршрутизаторе R2. В составе пула установим DNS-сервер 2001:db8:acad::254 и установите имя домена STATEFUL.com. Покажем результат:
