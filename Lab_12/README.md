...
- Настроим статический NAT на маршрутизаторах R14, R15 через интерфейс ***Loopback1*** для IP-адреса ***10.64.100.18*** (предварительно удалив эту сеть из протокола BGPна R14, R15), который принадлежит интерфейсу маршрутизатора ***R20***, покажем настройку на R15:

***R15***
```
R15(config)#ip nat source static 10.64.100.18 interface l1
```
...
R15#sh ip nat nvi translations
Pro Source global      Source local       Destin  local      Destin  global
icmp 37.85.13.15:1     10.64.100.18:1     23.100.40.1:1      23.100.40.1:1
--- 37.85.13.15        10.64.100.18       ---                ---
```
